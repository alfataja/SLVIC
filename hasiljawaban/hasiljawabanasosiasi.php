<div class="breadcrumb-holder">
  <div class="container-fluid">
    <ul class="breadcrumb">
      ...
      <li class="breadcrumb-item active"><a href="main.php?page=hasiljawaban/hasiljawabanasosiasi">Hasil Perhitungan</a></li>
    </ul>
  </div>
</div>
    ...
    <div class="row">
      <div class="col-sm-12">
        ...
        <div class="card-header">
          <h3 style="margin-top: 10px; margin-bottom: 10px;"><center>Hasil Perhitungan Asosiasi</center></h3>
        </div>
        ...
        if(item!=null){
          ...
          options: {
            ...
            showallTooltips: true,
              ...
              xmlhttp.open("GET","hasiljawaban/diagram/diagramAsosiasi.php?q="+item+"&tempat="+daerah+"&banding="+banding,true);
              xmlhttp.send();
            }
            }
