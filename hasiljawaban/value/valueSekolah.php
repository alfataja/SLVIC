<?php
include"../../konek/koneksiSekolah.php";
...
$sql = array();
	if($tempat==""){
		$skl = mysql_query("select*from pertanyaan3 where jawaban1='ada' ");
	$skla = mysql_query("select*from pertanyaan3 where jawaban1='tidak' ");
	$sklb = mysql_query("select*from pertanyaan3 where jawaban1='belum' ");
	}else{
		$skl = mysql_query("select*from pertanyaan3 inner join responden using (id_responden) where jawaban1='ada' && region='$tempat' ");
		$skla = mysql_query("select*from pertanyaan3 inner join responden using (id_responden) where jawaban1='tidak' && region='$tempat' ");
		$sklb = mysql_query("select*from pertanyaan3 inner join responden using (id_responden) where jawaban1='belum' && region='$tempat' ");
}
	$sql['jumlah1']=mysql_num_rows($skl);
	$sql['jumlah2']=mysql_num_rows($skla);
...
$sql = array();
	if($tempat==""){
		$skl = mysql_query("select*from pertanyaan5 where jawaban1='ya' ");
	$skla = mysql_query("select*from pertanyaan5 where jawaban1='tidak' ");
	}else{
		$skl = mysql_query("select*from pertanyaan5 inner join responden using (id_responden) where jawaban1='ya' && region='$tempat' ");
		$skla = mysql_query("select*from pertanyaan5 inner join responden using (id_responden) where jawaban1='tidak' && region='$tempat' ");
}
	$sql['jumlah1']=mysql_num_rows($skl);
	$sql['jumlah2']=mysql_num_rows($skla);
...
function lihatisi6($tempat){
	$sql = array();
	if($tempat==""){
		$skl = mysql_query("select*from pertanyaan6 where jawaban1='ya, pernah' ");
	$skla = mysql_query("select*from pertanyaan6 where jawaban1='tidak' ");
	}else{
		$skl = mysql_query("select*from pertanyaan6 inner join responden using (id_responden) where jawaban1='ya, pernah' && region='$tempat' ");
...
function lihatisi8($tempat){
	$sql = array();
	if($tempat==""){
		$skl = mysql_query("select*from pertanyaan8 where jawaban1='ya' ");
		$skla = mysql_query("select*from pertanyaan8 where jawaban1='tidak' ");
		$sklb = mysql_query("select*from pertanyaan8 where jawaban1='tidak tahu' ");
	}else{
		$skl = mysql_query("select*from pertanyaan8 inner join responden using (id_responden) where jawaban1='ya' && region='$tempat' ");
		$skla = mysql_query("select*from pertanyaan8 inner join responden using (id_responden) where jawaban1='tidak' && region='$tempat' ");
		$sklb = mysql_query("select*from pertanyaan8 inner join responden using (id_responden) where jawaban1='tidak tahu' && region='$tempat' ");
}
	$sql['jumlah1']=mysql_num_rows($skl);
	$sql['jumlah2']=mysql_num_rows($skla);
	$sql['jumlah3']=mysql_num_rows($sklb);
...
function lihatisi10($tempat){
	$sql = array();
	if($tempat==""){
	$skl = mysql_query("select*from pertanyaan10 where jawaban1='banyak' ");
	$skla = mysql_query("select*from pertanyaan10 where jawaban1='beberapa' ");
	$sklb = mysql_query("select*from pertanyaan10 where jawaban1='tidak ada' ");
	$sklc = mysql_query("select*from pertanyaan10 where jawaban1='tidak tahu' ");
	}else{
	$skl = mysql_query("select*from pertanyaan10 inner join responden using (id_responden) where jawaban1='banyak' && region='$tempat' ");
	$skla = mysql_query("select*from pertanyaan10 inner join responden using (id_responden) where jawaban1='beberapa' && region='$tempat' ");
	$sklb = mysql_query("select*from pertanyaan10 inner join responden using (id_responden) where jawaban1='tidak ada' && region='$tempat' ");
