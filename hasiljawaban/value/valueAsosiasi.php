...
function lihatisi3($tempat){
	$sql = array();
	if($tempat==""){
		$skl = mysql_query("select*from pertanyaan3 where jawaban1='Memiliki' ");
	$skla = mysql_query("select*from pertanyaan3 where jawaban1='Tidak Memi' ");
	}else{
	$skla =mysql_query("select*from pertanyaan3 inner join responden on responden.id_responden=pertanyaan2.id_responden where pertanyaan1.jawaban3='Memiliki' AND responden.region='$tempat' ");
	$skla =mysql_query("select*from pertanyaan3 inner join responden on responden.id_responden=pertanyaan2.id_responden where pertanyaan1.jawaban3='Tidak Memi' AND responden.region='$tempat' ");
}
	$sql['jumlah1']=mysql_num_rows($skl);
	$sql['jumlah2']=mysql_num_rows($skla);
	$sql['opsi1'] = "Memiliki";
...
function lihatisi6($tempat){
	$sql = array();
	if($tempat==""){
		$skl = mysql_query("select*from pertanyaan6 where jawaban1='Mengetahui' ");
	$skla = mysql_query("select*from pertanyaan6 where jawaban1='Tidak Mengetahui' ");
	}else{
		$skl = mysql_query("select*from pertanyaan6 inner join responden using (id_responden) where jawaban1='Mengetahui' && region='$tempat' ");
		$skla = mysql_query("select*from pertanyaan6 inner join responden using (id_responden) where jawaban1='Tidak Mengetahui' && region='$tempat' ");
}
	$sql['jumlah1']=mysql_num_rows($skl);
	$sql['jumlah2']=mysql_num_rows($skla);

	$sql['opsi1'] = "Mengetahui";
	$sql['opsi2'] = "Tidak Mengetahui";
	$sql['putar'] = 2;
	return $sql;
}
...
function lihatisi10($tempat){
	$sql = array();
	if($tempat==""){
	$skl = mysql_query("select*from pertanyaan10 where jawaban1='Sesuai' ");
	$skla = mysql_query("select*from pertanyaan10 where jawaban1='Tidak Sesuai' ");
	
	}else{
	$skl = mysql_query("select*from pertanyaan10 inner join responden using (id_responden) where jawaban1='Sesuai' && region='$tempat' ");
	$skla = mysql_query("select*from pertanyaan10 inner join responden using (id_responden) where jawaban1='Tidak Sesuai' && region='$tempat' ");
...
function lihatisi12($tempat){
	$sql = array();
	if($tempat==""){
	$skl = mysql_query("select*from pertanyaan12 where jawaban1='Mengetahui' ");
	$skla = mysql_query("select*from pertanyaan12 where jawaban1='Tidak Mengetahui' ");
	
	}else{
	$skl = mysql_query("select*from pertanyaan12 inner join responden using (id_responden) where jawaban1='Mengetahui' && region='$tempat' ");
	$skla = mysql_query("select*from pertanyaan12 inner join responden using (id_responden) where jawaban1='Tidak Mengetahui' && region='$tempat' ");
	}
