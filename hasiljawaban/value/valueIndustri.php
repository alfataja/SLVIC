...
function lihatisi6($tempat){
	$sql = array();
	if($tempat==""){
		$skl = mysql_query("select*from pertanyaan6 where jawaban1='Ya' ");
	$skla = mysql_query("select*from pertanyaan6 where jawaban1='Tidak' ");
	}else{
		$skl = mysql_query("select*from pertanyaan6 inner join responden using (id_responden) where jawaban1='Ya' && region='$tempat' ");
		$skla = mysql_query("select*from pertanyaan6 inner join responden using (id_responden) where jawaban1='Tidak' && region='$tempat' ");
}
	$sql['jumlah1']=mysql_num_rows($skl);
	$sql['jumlah2']=mysql_num_rows($skla);
...
function lihatisi7($tempat){
	$sql = array();
	if($tempat==""){
		$skl = mysql_query("select*from pertanyaan7 where jawaban1='Ya' ");
	$skla = mysql_query("select*from pertanyaan7 where jawaban1='Tidak' ");
	}else{
		$skl = mysql_query("select*from pertanyaan7 inner join responden using (id_responden) where jawaban1='Ya' && region='$tempat' ");
		$skla = mysql_query("select*from pertanyaan7 inner join responden using (id_responden) where jawaban1='Tidak' && region='$tempat' ");
}
	$sql['jumlah1']=mysql_num_rows($skl);
	$sql['jumlah2']=mysql_num_rows($skla);
...
function lihatisi10($tempat){
	$sql = array();
	if($tempat==""){
	$skl = mysql_query("select*from pertanyaan10 where jawaban1='banyak kesulitan' ");
	$skla = mysql_query("select*from pertanyaan10 where jawaban1='beberapa kesulitan' ");
	$sklb = mysql_query("select*from pertanyaan10 where jawaban1='tidak ada kesulitan' ");
	$sklc = mysql_query("select*from pertanyaan10 where jawaban1='tidak tahu' ");
	}else{
	$skl = mysql_query("select*from pertanyaan10 inner join responden using (id_responden) where jawaban1='banyak kesulitan' && region='$tempat' ");
	$skla = mysql_query("select*from pertanyaan10 inner join responden using (id_responden) where jawaban1='beberapa kesulitan' && region='$tempat' ");
	$sklb = mysql_query("select*from pertanyaan10 inner join responden using (id_responden) where jawaban1='tidak ada kesulitan' && region='$tempat' ");
	$sklc = mysql_query("select*from pertanyaan10 inner join responden using (id_responden) where jawaban1='tidak tahu' && region='$tempat' ");
...
function lihatisi27($tempat){
	$sql = array();
	if($tempat==""){
		$skl = mysql_query("select*from pertanyaan27 where jawaban1='pernah' ");
	$skla = mysql_query("select*from pertanyaan27 where jawaban1='tidak pernah' ");
	}else{
		$skl = mysql_query("select*from pertanyaan27 inner join responden using (id_responden) where jawaban1='pernah' && region='$tempat' ");
		$skla = mysql_query("select*from pertanyaan27 inner join responden using (id_responden) where jawaban1='tidak pernah' && region='$tempat' ");
}
	$sql['jumlah1']=mysql_num_rows($skl);
	$sql['jumlah2']=mysql_num_rows($skla);
...
function lihatisi30($tempat){
	$sql = array();
	if($tempat==""){
		$skl = mysql_query("select*from pertanyaan30 where jawaban1='ada' ");
	$skla = mysql_query("select*from pertanyaan30 where jawaban1='tidak ada' ");
	}else{
		$skl = mysql_query("select*from pertanyaan30 inner join responden using (id_responden) where jawaban1='ada' && region='$tempat' ");
		$skla = mysql_query("select*from pertanyaan30 inner join responden using (id_responden) where jawaban1='tidak ada' && region='$tempat' ");
}
	$sql['jumlah1']=mysql_num_rows($skl);
	$sql['jumlah2']=mysql_num_rows($skla);
	$sql['opsi1'] = "Masih Ada";
