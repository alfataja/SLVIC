...
function lihatisi8($tempat){
	$sql = array();
	if($tempat==""){
		$skl = mysql_query("select*from pertanyaan8 where jawaban1='terbuka' ");
		$skla = mysql_query("select*from pertanyaan8 where jawaban1='networking' ");
		$sklb = mysql_query("select*from pertanyaan8 where jawaban1='kerja sama' ");

	}else{
		$skl = mysql_query("select*from pertanyaan8 inner join responden using (id_responden) where jawaban1='terbuka' && region='$tempat' ");
		$skla = mysql_query("select*from pertanyaan8 inner join responden using (id_responden) where jawaban1='networking' && region='$tempat' ");
		$sklb = mysql_query("select*from pertanyaan8 inner join responden using (id_responden) where jawaban1='kerja sama' && region='$tempat' ");
}
	$sql['jumlah1']=mysql_num_rows($skl);
	$sql['jumlah2']=mysql_num_rows($skla);
	$sql['jumlah3']=mysql_num_rows($sklb);

	$sql['opsi1'] = "Rekrutmen terbuka di media";
	$sql['opsi2'] = "Networking perusahaan";
	$sql['opsi3'] = "Kerja sama dengan lembaga tertentu";
...
function lihatisi9($tempat){
	$sql = array();
	if($tempat==""){
	$skl = mysql_query("select*from pertanyaan9 where jawaban1='20' ");
	$skla = mysql_query("select*from pertanyaan9 where jawaban1='25' ");
	$sklb = mysql_query("select*from pertanyaan9 where jawaban1='30' ");
	$sklc = mysql_query("select*from pertanyaan9 where jawaban1='35' ");
	$skld = mysql_query("select*from pertanyaan9 where jawaban1='tidak ada' ");
	}else{
	$skl = mysql_query("select*from pertanyaan9 inner join responden using (id_responden) where jawaban1='20' && region='$tempat' ");
	$skla = mysql_query("select*from pertanyaan9 inner join responden using (id_responden) where jawaban1='25' && region='$tempat' ");
	$sklb = mysql_query("select*from pertanyaan9 inner join responden using (id_responden) where jawaban1='30' && region='$tempat' ");
	$sklc = mysql_query("select*from pertanyaan9 inner join responden using (id_responden) where jawaban1='35' && region='$tempat' ");
	$skld = mysql_query("select*from pertanyaan9 inner join responden using (id_responden) where jawaban1='tidak ada' && region='$tempat' ");
}
	$sql['jumlah1']=mysql_num_rows($skl);
	$sql['jumlah2']=mysql_num_rows($skla);
	$sql['jumlah3']=mysql_num_rows($sklb);
	...
	$sql['opsi1'] = "Maksimal 20 Tahun";
	$sql['opsi2'] = "Maksimal 25 Tahun";
	$sql['opsi3'] = "Maksimal 30 Tahun";
	$sql['opsi4'] = "Maksimal 35 Tahun";
	$sql['opsi5'] = "Tidak ada batasan";
...
function lihatisi10($tempat){
	$sql = array();
	if($tempat==""){
	$skl = mysql_query("select*from pertanyaan10 where jawaban1='ya' ");
	$skla = mysql_query("select*from pertanyaan10 where jawaban1='belum' ");

	}else{
	$skl = mysql_query("select*from pertanyaan10 inner join responden using (id_responden) where jawaban1='ya' && region='$tempat' ");
	$skla = mysql_query("select*from pertanyaan10 inner join responden using (id_responden) where jawaban1='belum' && region='$tempat' ");
...
function lihatisi15($tempat){
	$sql = array();
	if($tempat==""){
	$skl = mysql_query("select*from pertanyaan15 where jawaban1='motivasi' ");
	$skla = mysql_query("select*from pertanyaan15 where jawaban1='pelatihan hanya sebagian' ");
	$sklb = mysql_query("select*from pertanyaan15 where jawaban1='staff tidak sesuai keterampilan' ");
	$sklc = mysql_query("select*from pertanyaan15 where jawaban1='lainnya' ");

	}else{
	$skl = mysql_query("select*from pertanyaan15 inner join responden using (id_responden) where jawaban1='motivasi' && region='$tempat' ");
	$skla = mysql_query("select*from pertanyaan15 inner join responden using (id_responden) where jawaban1='pelatihan hanya sebagian' && region='$tempat' ");
	$sklb = mysql_query("select*from pertanyaan15 inner join responden using (id_responden) where jawaban1='staff tidak sesuai keterampilan' && region='$tempat' ");
	$sklc = mysql_query("select*from pertanyaan15 inner join responden using (id_responden) where jawaban1='lainnya' && region='$tempat' ");
	...
	$sql['opsi1'] = "Kurang motivasi";
	$sql['opsi2'] = "Pelatihan hanya sebagian yang selesai";
	$sql['opsi3'] = "Tidak dapat merekrut staf yang sesuai keterampilan yang diperlukan";
	$sql['opsi4'] = "Lainnya";
...
$sql = array();
	if($tempat==""){
		$skl = mysql_query("select*from pertanyaan17 where jawaban1='ya' ");
	$skla = mysql_query("select*from pertanyaan17 where jawaban1='tidak' ");
	}else{
		$skl = mysql_query("select*from pertanyaan17 inner join responden using (id_responden) where jawaban1='ya' && region='$tempat' ");
		$skla = mysql_query("select*from pertanyaan17 inner join responden using (id_responden) where jawaban1='tidak' && region='$tempat' ");
}
	$sql['jumlah1']=mysql_num_rows($skl);
	$sql['jumlah2']=mysql_num_rows($skla);
...
function lihatisi20($tempat){
	$sql = array();
	if($tempat==""){
		$skl = mysql_query("select*from pertanyaan20 where jawaban1='kadang-kadang' ");
		$skla = mysql_query("select*from pertanyaan20 where jawaban1='selalu' ");
		$sklb = mysql_query("select*from pertanyaan20 where jawaban1='Hanya tim BLK yang menyusun, kemudian diinfokan ke industri' ");

	}else{
		$skl = mysql_query("select*from pertanyaan20 inner join responden using (id_responden) where jawaban1='kadang-kadang' && region='$tempat' ");
		$skla = mysql_query("select*from pertanyaan20 inner join responden using (id_responden) where jawaban1='selalu' && region='$tempat' ");
		$sklb = mysql_query("select*from pertanyaan20 inner join responden using (id_responden) where jawaban1='Hanya tim BLK yang menyusun, kemudian diinfokan ke industri' && region='$tempat' ");
}
	$sql['jumlah1']=mysql_num_rows($skl);
	$sql['jumlah2']=mysql_num_rows($skla);
	$sql['jumlah3']=mysql_num_rows($sklb);

	$sql['opsi1'] = "kadang-kadang";
	$sql['opsi2'] = "Selalu";
	$sql['opsi3'] = "Hanya Tim BLK";
...
$sql = array();
	if($tempat==""){
		$skl = mysql_query("select*from pertanyaan21 where jawaban1='Sudah seluruhnya: 100%' ");
		$skla = mysql_query("select*from pertanyaan21 where jawaban1='> 75% < 99%' ");
		$sklb = mysql_query("select*from pertanyaan21 where jawaban1='<75%' ");

	}else{
		$skl = mysql_query("select*from pertanyaan21 inner join responden using (id_responden) where jawaban1='Sudah seluruhnya: 100%' && region='$tempat' ");
		$skla = mysql_query("select*from pertanyaan21 inner join responden using (id_responden) where jawaban1='> 75% < 99%' && region='$tempat' ");
		$sklb = mysql_query("select*from pertanyaan21 inner join responden using (id_responden) where jawaban1='<75%' && region='$tempat' ");
}
	$sql['jumlah1']=mysql_num_rows($skl);
	$sql['jumlah2']=mysql_num_rows($skla);
	$sql['jumlah3']=mysql_num_rows($sklb);
...
$sql = array();
	if($tempat==""){
		$skl = mysql_query("select*from pertanyaan23 where jawaban1='Seluruhnya materi praktek di BLK dan on the job di Industri' ");
		$skla = mysql_query("select*from pertanyaan23 where jawaban1='70 : 30 termasuk on the job' ");
		$sklb = mysql_query("select*from pertanyaan23 where jawaban1='60 : 40 termasuk on the job' ");

	}else{
		$skl = mysql_query("select*from pertanyaan23 inner join responden using (id_responden) where jawaban1='Seluruhnya materi praktek di BLK dan on the job di Industri' && region='$tempat' ");
		$skla = mysql_query("select*from pertanyaan23 inner join responden using (id_responden) where jawaban1='70 : 30 termasuk on the job' && region='$tempat' ");
		$sklb = mysql_query("select*from pertanyaan23 inner join responden using (id_responden) where jawaban1='60 : 40 termasuk on the job' && region='$tempat' ");
}
	$sql['jumlah1']=mysql_num_rows($skl);
	$sql['jumlah2']=mysql_num_rows($skla);
	$sql['jumlah3']=mysql_num_rows($sklb);
...
$sql = array();
	if($tempat==""){
		$skl = mysql_query("select*from pertanyaan24 where jawaban1='ya tersedia' ");
	$skla = mysql_query("select*from pertanyaan24 where jawaban1='tidak' ");
	}else{
		$skl = mysql_query("select*from pertanyaan24 inner join responden using (id_responden) where jawaban1='ya tersedia' && region='$tempat' ");
		$skla = mysql_query("select*from pertanyaan24 inner join responden using (id_responden) where jawaban1='tidak' && region='$tempat' ");
}
	$sql['jumlah1']=mysql_num_rows($skl);
	$sql['jumlah2']=mysql_num_rows($skla);
...
function lihatisi25($tempat){
	$sql = array();
	if($tempat==""){
		$skl = mysql_query("select*from pertanyaan25 where jawaban1='ya' ");
	$skla = mysql_query("select*from pertanyaan25 where jawaban1='tidak' ");
	}else{
		$skl = mysql_query("select*from pertanyaan25 inner join responden using (id_responden) where jawaban1='ya' && region='$tempat' ");
		$skla = mysql_query("select*from pertanyaan25 inner join responden using (id_responden) where jawaban1='tidak' && region='$tempat' ");
}
	$sql['jumlah1']=mysql_num_rows($skl);
	$sql['jumlah2']=mysql_num_rows($skla);
...
function lihatisi27($tempat){
	$sql = array();
	if($tempat==""){
		$skl = mysql_query("select*from pertanyaan27 where jawaban1='selalu' ");
	$skla = mysql_query("select*from pertanyaan27 where jawaban1='kadang-kadang' ");
	$sklb = mysql_query("select*from pertanyaan27 where jawaban1='belum pernah' ");
	$sklc = mysql_query("select*from pertanyaan27 where jawaban1='tidak pernah sama sekali' ");
	}else{
		$skl = mysql_query("select*from pertanyaan27 inner join responden using (id_responden) where jawaban1='selalu' && region='$tempat' ");
		$skla = mysql_query("select*from pertanyaan27 inner join responden using (id_responden) where jawaban1='kadang-kadang' && region='$tempat' ");
		$sklb = mysql_query("select*from pertanyaan27 inner join responden using (id_responden) where jawaban1='belum pernah' && region='$tempat' ");
		$sklc = mysql_query("select*from pertanyaan27 inner join responden using (id_responden) where jawaban1='tidak pernah sama sekali' && region='$tempat' ");
}
	$sql['jumlah1']=mysql_num_rows($skl);
	$sql['jumlah2']=mysql_num_rows($skla);
	$sql['jumlah3']=mysql_num_rows($sklb);
	...
	$sql['opsi1'] = "Selalu";
	$sql['opsi2'] = "Kadang-kadang";
	$sql['opsi3'] = "Belum Pernah";
	$sql['opsi4'] = "Tidak Pernah";
	$sql['putar'] = 4;
	return $sql;
}
...
$sql = array();
	if($tempat==""){
		$skl = mysql_query("select*from pertanyaan28 where jawaban1='selalu' ");
	$skla = mysql_query("select*from pertanyaan28 where jawaban1='sebagian besar' ");
	$sklb = mysql_query("select*from pertanyaan28 where jawaban1='sebagian kecil' ");
	$sklc = mysql_query("select*from pertanyaan28 where jawaban1='tidak pernah sama sekali' ");
	}else{
		$skl = mysql_query("select*from pertanyaan28 inner join responden using (id_responden) where jawaban1='selalu' && region='$tempat' ");
		$skla = mysql_query("select*from pertanyaan28 inner join responden using (id_responden) where jawaban1='sebagian besar' && region='$tempat' ");
		$sklb = mysql_query("select*from pertanyaan28 inner join responden using (id_responden) where jawaban1='sebagian kecil' && region='$tempat' ");
		$sklc = mysql_query("select*from pertanyaan28 inner join responden using (id_responden) where jawaban1='tidak pernah sama sekali' && region='$tempat' ");
}
	$sql['jumlah1']=mysql_num_rows($skl);
	$sql['jumlah2']=mysql_num_rows($skla);
	$sql['jumlah3']=mysql_num_rows($sklb);
	...
	$sql['opsi1'] = "Selalu";
	$sql['opsi2'] = "Sebagian Besar";
	$sql['opsi3'] = "Sebagian Kecil";
	$sql['opsi4'] = "Tidak Pernah";
	$sql['putar'] = 4;
	return $sql;
...
function lihatisi29($tempat){
	$sql = array();
	if($tempat==""){
		$skl = mysql_query("select*from pertanyaan29 where jawaban1='Pada awal tahun' ");
		$skla = mysql_query("select*from pertanyaan29 where jawaban1='Sewaktu-waktu sesuai dengan ke' ");
		$sklb = mysql_query("select*from pertanyaan29 where jawaban1='lainnya' ");

	}else{
		$skl = mysql_query("select*from pertanyaan29 inner join responden using (id_responden) where jawaban1='Pada awal tahun' && region='$tempat' ");
		$skla = mysql_query("select*from pertanyaan29 inner join responden using (id_responden) where jawaban1='Sewaktu-waktu sesuai dengan ke' && region='$tempat' ");
		$sklb = mysql_query("select*from pertanyaan29 inner join responden using (id_responden) where jawaban1='lainnya' && region='$tempat' ");
}
	$sql['jumlah1']=mysql_num_rows($skl);
	$sql['jumlah2']=mysql_num_rows($skla);
	$sql['jumlah3']=mysql_num_rows($sklb);

	$sql['opsi1'] = "Awal Tahun";
	$sql['opsi2'] = "Sewaktu-waktu";
	$sql['opsi3'] = "Lainnya";
...
function lihatisi30($tempat){
	$sql = array();
	if($tempat==""){
		$skl = mysql_query("select*from pertanyaan30 where jawaban1='selalu' ");
	$skla = mysql_query("select*from pertanyaan30 where jawaban1='tidak' ");
	}else{
		$skl = mysql_query("select*from pertanyaan30 inner join responden using (id_responden) where jawaban1='selalu' && region='$tempat' ");
		$skla = mysql_query("select*from pertanyaan30 inner join responden using (id_responden) where jawaban1='tidak' && region='$tempat' ");
}
	$sql['jumlah1']=mysql_num_rows($skl);
	$sql['jumlah2']=mysql_num_rows($skla);
	$sql['opsi1'] = "Selalu";
...
$sql = array();
	if($tempat==""){
		$skl = mysql_query("select*from pertanyaan35 where jawaban1='Langsung setelah akhir program pelatihan' ");
	$skla = mysql_query("select*from pertanyaan35 where jawaban1='Pasca masa tunggu paling lama 3 bulan' ");
	$sklb = mysql_query("select*from pertanyaan35 where jawaban1='Pasca masa tunggu antara 3 sd 6 bulan' ");
	$sklc = mysql_query("select*from pertanyaan35 where jawaban1='Pasca tunggu diatas 6 bulan' ");
	$skld = mysql_query("select*from pertanyaan35 where jawaban1='Belum pernah dilakukan survei' ");
	}else{
		$skl = mysql_query("select*from pertanyaan35 inner join responden using (id_responden) where jawaban1='Langsung setelah akhir program pelatihan' && region='$tempat' ");
		$skla = mysql_query("select*from pertanyaan35 inner join responden using (id_responden) where jawaban1='Pasca masa tunggu paling lama 3 bulan' && region='$tempat' ");
		$sklb = mysql_query("select*from pertanyaan35 inner join responden using (id_responden) where jawaban1='Pasca masa tunggu antara 3 sd 6 bulan' && region='$tempat' ");
		$sklc = mysql_query("select*from pertanyaan35 inner join responden using (id_responden) where jawaban1='Pasca tunggu diatas 6 bulan' && region='$tempat' ");
		$skld = mysql_query("select*from pertanyaan35 inner join responden using (id_responden) where jawaban1='Belum pernah dilakukan survei' && region='$tempat' ");
}
	$sql['jumlah1']=mysql_num_rows($skl);
	$sql['jumlah2']=mysql_num_rows($skla);
	$sql['jumlah3']=mysql_num_rows($sklb);
	$sql['jumlah4']=mysql_num_rows($sklc);
	$sql['jumlah5']=mysql_num_rows($sklc);

	$sql['opsi1'] = "Langsung setelah akhir program";
	$sql['opsi2'] = "Pasca 3 Bulan";
	$sql['opsi3'] = "Pasca 3-6 Bulan";
	$sql['opsi4'] = "Pasca 6 Bulan";
	$sql['opsi5'] = "Belum ada survei";
	$sql['putar'] = 5;
	return $sql;
...
function lihatisi36($tempat){
	$sql = array();
	if($tempat==""){
		$skl = mysql_query("select*from pertanyaan36 where jawaban1='ya' ");
	$skla = mysql_query("select*from pertanyaan36 where jawaban1='belum' ");
	}else{
		$skl = mysql_query("select*from pertanyaan36 inner join responden using (id_responden) where jawaban1='ya' && region='$tempat' ");
		$skla = mysql_query("select*from pertanyaan36 inner join responden using (id_responden) where jawaban1='belum' && region='$tempat' ");
}
	$sql['jumlah1']=mysql_num_rows($skl);
	$sql['jumlah2']=mysql_num_rows($skla);
	$sql['opsi1'] = "Ya";
...
function lihatisi45($tempat){
	$sql = array();
	if($tempat==""){
		$skl = mysql_query("select*from pertanyaan45 where jawaban1='ya' ");
	$skla = mysql_query("select*from pertanyaan45 where jawaban1='belum' ");
	}else{
		$skl = mysql_query("select*from pertanyaan45 inner join responden using (id_responden) where jawaban1='ya' && region='$tempat' ");
		$skla = mysql_query("select*from pertanyaan45 inner join responden using (id_responden) where jawaban1='belum' && region='$tempat' ");
}
	$sql['jumlah1']=mysql_num_rows($skl);
	$sql['jumlah2']=mysql_num_rows($skla);
	$sql['opsi1'] = "Ya";
...
if($tempat==""){
		$skl = mysql_query("select*from pertanyaan47 where jawaban1='ya' ");
	$skla = mysql_query("select*from pertanyaan47 where jawaban1='belum' ");
	}else{
		$skl = mysql_query("select*from pertanyaan47 inner join responden using (id_responden) where jawaban1='ya' && region='$tempat' ");
		$skla = mysql_query("select*from pertanyaan47 inner join responden using (id_responden) where jawaban1='belum' && region='$tempat' ");
}
	$sql['jumlah1']=mysql_num_rows($skl);
	$sql['jumlah2']=mysql_num_rows($skla);
	$sql['opsi1'] = "Ya";
