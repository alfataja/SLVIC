...
function lihatisi2($tempat){
	...
	$skla = mysql_query("select*from pertanyaan2 where jawaban1='tidak' ");
		...
		$skl = mysql_query("select*from pertanyaan2 inner join responden using (id_responden) where jawaban1='ya' && region='$tempat' ");
		$skla = mysql_query("select*from pertanyaan2 inner join responden using (id_responden) where jawaban1='tidak' && region='$tempat' ");
}
	$sql['jumlah1']=mysql_num_rows($skl);
	$sql['jumlah2']=mysql_num_rows($skla);
...
$sql = array();
	if($tempat==""){
		$skl = mysql_query("select*from pertanyaan3 where jawaban1='ya' ");
	$skla = mysql_query("select*from pertanyaan3 where jawaban1='tidak' ");
	}else{
		$skl = mysql_query("select*from pertanyaan3 inner join responden using (id_responden) where jawaban1='ya' && region='$tempat' ");
