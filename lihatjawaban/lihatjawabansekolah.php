<?php include"konek/koneksiSekolah.php";
  include"get/getSekolah.php";
...
<div class="breadcrumb-holder">
 <div class="container-fluid">
    <ul class="breadcrumb">
      ...
      <li class="breadcrumb-item active"><a href="main.php?page=lihatjawaban/lihatjawabansekolah">Jawaban Responden</a></li>
    </ul>
  </div>
</div>
      ...
      <div class="col-lg-12">
        <div class="card" style="margin-top:30px;">
          <div class="card-header">
            <h3 style="margin-top: 3px; margin-bottom: 3px;"><center>Tabel Lihat Jawaban Responden Sekolah</center></h3>
          </div>
          <!-- Awal mulai Region -->
          <div class="card-body">
            <div class="row">
                ...
                <table class="table table-sm text-center" id="dataTables">
                   ...
                   <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php echo $buff['nm_sekolah'];?></td>
                      <td><?php echo $buff['region'];?></td>
                      <td>
                       <a href="main.php?page=detailjawaban/detailSekolah&id_responden=<?php echo $buff['id_responden']?>">
        ...
        isi.innerHTML="Avavava";
          ...
          if(xmlhttp.readyState == 4 && xmlhttp.status == 200){
            ...
            //alert(xmlhttp.responseText);
              ...
              xmlhttp.open("GET","region/regionSekolah.php?q="+item,true);
              xmlhttp.send();
            }
    </script>
</section>
