...
<div class="breadcrumb-holder">
    <div class="container-fluid">
      <ul class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><a href="main.php?page=detailjawaban/detailSekolah&id_responden=<?php echo $buff['id_responden']?>">Detail Jawaban Responden</a></li>
      </ul>
    </div>
</div>
<section>
