<?php include "konek/koneksiKawasan.php";
$id =$_GET['id_responden'];
include "get/getKawasan.php";
//$id =$_POST['id'];
$soal = soalPertanyaan();
$query1 = array() ;
...
<div class="breadcrumb-holder">
    <div class="container-fluid">
      <ul class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><a href="main.php?page=detailjawaban/detailKawasan&id_responden=<?php echo $buff['id_responden']?>">Detail Jawaban Responden</a></li>
      </ul>
    </div>
</div>
<section>
